    ...
    if args.sample_id == 0:
        for template in range(751, 801):
            ...
            for sample_directory in sample_directories:
                output_path = os.path.join(args.output_path, f'{template}_'+f'{sample_directory.split('_sample')[-1]}.img.nii.gz')
        ...
        for sample_directory in sample_directories:
            output_path = os.path.join(args.output_path, f'{args.sample_id}_'+f'{sample_directory.split('_sample')[-1]}.img.nii.gz')
            stitch_and_normalize_volumes(sample_directory, file_pattern, output_path, args.level, args.gt_directory)