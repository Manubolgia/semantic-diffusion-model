...
class ImageDataset(Dataset):
    ...
    def create_reference(self, path):
        ...
        if self.resolution == 176:
            ...
            reference_path = os.path.join(os.path.dirname(path).replace('septal_cta', 'septal_cta_reference'), reference_path)
            ...
            reference_path = os.path.join(os.path.dirname(path).replace('coronary_cta', 'coronary_cta_reference'), reference_path)
