...
class ImageDataset(Dataset):
    ...
    def create_reference(self, path):
        ...
        if self.resolution == 176:
            ...
            reference_path = os.path.join(os.path.dirname(path).replace('septal_cta', 'cta_reference_32'), reference_path)
        elif self.dataset_mode == 'dilation':
            reference_path = os.path.join(os.path.dirname(path).replace('dilation_cta', 'cta_reference_32'), reference_path)
        elif self.dataset_mode == 'hypertrophy':
            reference_path = os.path.join(os.path.dirname(path).replace('hypertrophy_cta', 'cta_reference_32'), reference_path)
        else:
